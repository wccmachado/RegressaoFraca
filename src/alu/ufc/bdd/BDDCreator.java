...
public class BDDCreator {
    ...
    public BDD createExclusiveXorBdd(String line) {
        StringTokenizer tkn = new StringTokenizer(line, ",");
        String tknPiece;
        ...
        while (tkn.hasMoreTokens()) {
            String aux1;
            aux1 = tkn.nextToken();
            if (aux1.contains("waypoint")) {
                setWaypoint.add(aux1);
            } else {
                setRoverStore.add(aux1);
            }
        }
    ...
    public BDD createExclusiveXorStoreBdd(String line) {
        StringTokenizer tkn = new StringTokenizer(line, ",");
        String tknPiece;
